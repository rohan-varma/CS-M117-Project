...
def testTargetInAlliance():
	...
	user2_data.append(allId)
	user3_data.append(allId)
	user4_data.append(allId)
	testJoinAllliance(user2_data)
	testJoinAllliance(user3_data)
	#attempt to kill the target
	testKillTarget(user1_data)
